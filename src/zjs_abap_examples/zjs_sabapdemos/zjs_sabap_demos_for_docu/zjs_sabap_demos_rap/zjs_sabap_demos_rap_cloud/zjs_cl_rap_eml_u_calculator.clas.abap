CLASS zjs_cl_rap_eml_u_calculator DEFINITION
  ...
  PRIVATE SECTION.
    DATA:
      num1      TYPE c LENGTH 7 VALUE 2,
      num2      TYPE c LENGTH 7 VALUE 3,
      arithm_op TYPE c LENGTH 1 VALUE '+'.
...
CLASS ZJS_CL_RAP_EML_U_CALCULATOR IMPLEMENTATION.
...
*     )->request( ).
    ...
    TRY.
        MODIFY ENTITY zcjs_cs_rap_draft_m
    ...
    COMMIT ENTITIES RESPONSE OF zcjs_cs_rap_draft_m REPORTED DATA(rep).
    ...
    SELECT SINGLE num1, arithm_op, num2, calc_result
     FROM zdjs_cs_tab_calc INTO @FINAL(calculation).
