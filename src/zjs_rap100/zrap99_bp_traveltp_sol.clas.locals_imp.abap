...
CLASS lhc_travel IMPLEMENTATION.
  ...
  METHOD earlynumbering_create.
    DATA:
      entity           TYPE STRUCTURE FOR CREATE ZRAP99_R_TravelTP_sol,
    ...
    ELSE.
      ...
      SELECT SINGLE FROM zrap99_atravsol FIELDS MAX( travel_id ) AS travelID INTO @travel_id_max.
      "Get max travel ID from draft table
      SELECT SINGLE FROM zrap99_dtravsol FIELDS MAX( travelid ) INTO @DATA(max_travelid_draft).
  ...
  METHOD setStatusToOpen.
    ...
    READ ENTITIES OF ZRAP99_R_TravelTP_sol IN LOCAL MODE
     ENTITY Travel
    ...
    MODIFY ENTITIES OF ZRAP99_R_TravelTP_sol IN LOCAL MODE
      ENTITY Travel
        UPDATE SET FIELDS
...
**************************************************************************
  METHOD deductDiscount.
    DATA travels_for_update TYPE TABLE FOR UPDATE ZRAP99_R_TravelTP_sol.
...
**************************************************************************
  METHOD copyTravel.
    DATA: travels TYPE TABLE FOR CREATE zrap99_r_traveltp_sol\\travel.
    ...
    MODIFY ENTITIES OF zrap99_r_traveltp_sol IN LOCAL MODE
        ENTITY travel CREATE FIELDS ( AgencyID CustomerID BeginDate EndDate BookingFee TotalPrice CurrencyCode OverallStatus Description )
          WITH travels MAPPED DATA(mapped_create).
