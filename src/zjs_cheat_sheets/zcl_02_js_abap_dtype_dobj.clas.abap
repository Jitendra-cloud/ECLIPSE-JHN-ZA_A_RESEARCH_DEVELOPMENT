...
CLASS zcl_02_js_abap_dtype_dobj DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_02_JS_ABAP_DTYPE_DOBJ IMPLEMENTATION.
...
**********************************************************************
    ...
    DATA lt_demo TYPE zdty_demo.
    DATA lt_demo2 TYPE STANDARD TABLE OF zds_demo.

    lt_demo = VALUE #( ( cname = 'demo' cname1 = 'demo2' cname2 = 6 )
                       ( cname = 'demo1' cname1 = 'demo2' cname2 = 8 )
                       ( cname = 'demo1' cname1 = 'demo2' cname2 = 8 )
                       ( cname = 'demo2' cname1 = 'demo2' cname2 = 6 )
                       ( cname = 'demo' cname1 = 'demo2' cname2 = 6 )  ).

    LOOP AT lt_demo ASSIGNING FIELD-SYMBOL(<fs_demo>).
      IF <fs_demo>-cname = 'demo1'.
        <fs_demo>-cname2 = 10.

*        MODIFY lt_demo FROM ls_demo.
      ENDIF.
...
**********************************************************************
    ...
    "CLASS-DATA: read_only_attribute TYPE string VALUE `Hallo` READ-ONLY.
    IF zcl_02_js_abap_dtype_dobj=>read_only_attribute = `adapt read only attribute`.
      ...
...
**********************************************************************
    ...
    DATA(oref) = NEW zcl_02_js_abap_dtype_dobj( ).
