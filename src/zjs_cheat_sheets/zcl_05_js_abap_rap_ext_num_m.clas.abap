...
"! </ul>
CLASS zcl_05_js_abap_rap_ext_num_m DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*        WITH VALUE #( ( %cid = 'cid1' key_field = 1 field1 = 'aaa'   field2 = 'bbb'   field3 = 10 field4 = 11 ) "Value not considered
*                      ( %cid = 'cid2' key_field = 2 field1 = 'ccc'   field2 = 'ddd'   field3 = 20 )
*                      ( %cid = 'cid3' key_field = 3 field1 = 'eee'   field2 = 'fff'   field3 = 30 )
*                      ( %cid = 'cid4' key_field = 4 field1 = 'error' field2 = 'error' field3 = 99 ) )  ""  ( %cid = 'cid4' "Instance to fail
*        MAPPED mapped
*        FAILED failed
*        REPORTED reported.
*
...
*    MODIFY ENTITIES OF zdemo_abap_rap_ro_m
*        ENTITY root
*        CREATE FROM VALUE #( %control-key_field = if_abap_behv=>mk-on %control-field1 = if_abap_behv=>mk-on %control-field2 = if_abap_behv=>mk-on %control-field3 = if_abap_behv=>mk-on %control-field4 = if_abap_behv=>mk-on
*                           ( %cid = 'cid5' key_field = 5 field1 = 'iii' field2 = 'jjj' field3 = 50 field4 = 51 ) )
*        UPDATE FIELDS ( field1 field3 field4 )
*                            "Update via cid_ref
*               WITH VALUE #( ( %cid_ref = 'cid5' field1   = 'up_kkk' field2   = 'up_lll' field3   = 500 field4   = 501 )   "field2   = 'up_lll' "Value not considered
*                            "Updates via key
*                             ( key_field = 1 field1  = 'up_mmm' field3 = 100 field4 = 101 )
*                             ( key_field = 2 field1  = 'up_ooo' field3 = 200 field4 = 201 )
*                             ( key_field = 99 field3 = 99       field4 = 99 ) )  ""key_field = 99   "Instance to fail
*        MAPPED mapped
*        FAILED failed
*        REPORTED reported.
*
...
*      FIELDS key_field, field1, field2, field3, field4
*      ORDER BY key_field
*      INTO TABLE @DATA(tab_root2).
*
*    out->write( data = tab_root2 name = `tab_root` ).
*    out->write( |\n| ).
*
*    "Displaying response information
*    IF mapped-root IS NOT INITIAL.
...
*
*    MODIFY ENTITIES OF zdemo_abap_rap_ro_m
*        ENTITY root CREATE FIELDS ( key_field field1 field2 field3 field4 )
*          WITH VALUE #( ( %cid = 'cid_del' key_field = 6 field1 = 'mmm' field2 = 'nnn' field3 = 60 field4 = 61 ) )
*        DELETE FROM VALUE #( ( %cid_ref = 'cid_del' ) "Deletion via %cid_ref
*                             ( key_field = 4 )   "Deletions via key
...
*      FIELDS key_field, field1, field2, field3, field4
*      ORDER BY key_field
*      INTO TABLE @DATA(tab_root3).
*
*    out->write( data = tab_root3 name = `tab_root` ).
*    out->write( |\n| ).
*
*    "Displaying response information
*    IF mapped-root IS NOT INITIAL.
...
*    MODIFY ENTITIES OF zdemo_abap_rap_ro_m
*        ENTITY root CREATE FIELDS ( key_field field1 field2 field3 field4 )
*          WITH VALUE #( ( %cid = 'cid_x2' key_field = 7 field1 = 'ooo' field2 = 'ppp' field3 = 70 field4 = 71 ) )
*        EXECUTE multiply_by_2 FROM VALUE #( ( %cid_ref = 'cid_x2' )  "Executing action via %cid_ref
*                                            ( key_field  =  1  )     "Executing action via key
*                                            ( key_field  =  2  )     "Executing action via key
...
*      FIELDS key_field, field1, field2, field3, field4
*      ORDER BY key_field
*      INTO TABLE @DATA(tab_root4).
*
*    out->write( data = tab_root4 name = `tab_root` ).
*    out->write( |\n| ).
*
*    "Displaying response information
*    IF mapped-root IS NOT INITIAL.
...
*    ENDIF.
    ...
    MODIFY ENTITIES OF zdemo_abap_rap_ro_m
        ENTITY root CREATE FIELDS ( key_field field1 field2 field3 field4 )
              WITH VALUE #( ( %cid = 'cid_cba' key_field = 9 field1 = 'qqq' field2 = 'rrr' field3 = 90 field4 = 91 ) )
        CREATE BY \_child FIELDS ( key_ch field_ch1 field_ch2 ) WITH VALUE #(
          "CBA operation via %cid_ref
          ( %cid_ref = 'cid_cba' %target = VALUE #( ( %cid = 'cid_ch1' key_ch = 9 field_ch1 = 'aaa_ch' field_ch2 = 99 )
                                                    ( %cid = 'cid_ch2' key_ch = 10 field_ch1 = 'bbb_ch' field_ch2 = 100 ) ) )
          "CBA operation via root key
          ( key_field = 1        %target = VALUE #( ( %cid = 'cid_ch3' key_ch = 1 field_ch1 = 'ccc_ch' field_ch2 = 11 )
                                                    ( %cid = 'cid_ch4' key_ch = 2 field_ch1 = 'ddd_ch' field_ch2 = 22 ) ) )

          ( key_field = 2        %target = VALUE #( ( %cid = 'cid_ch5' key_ch = 3 field_ch1 = 'ccc_ch' field_ch2 = 33 )
                                                    ( %cid = 'cid_ch6' key_ch = 4 field_ch1 = 'ddd_ch' field_ch2 = 44 ) ) )
          "Instance to fail
          ( key_field = 123      %target = VALUE #( ( %cid = 'cid_ch7' key_ch = 1 field_ch1 = 'error' field_ch2 = 2 )
                                                    ( %cid = 'cid_ch8' key_ch = 2 field_ch1 = 'error' field_ch2 = 3 ) ) ) )
    ...
    out->write( data = tab_root5 name = `tab_root` ).
    out->write( |\n| ).
...
*          WITH VALUE #( ( %cid = 'cid_val1' key_field = 123 field1 = 'sss' field2 = 'ttt' field3 = 1 field4 = 2 )
*                        ( %cid = 'cid_val2' key_field = 456 field1 = 'uuu' field2 = 'vvv' field3 = 3 field4 = 4 )
*                        ( %cid = 'cid_val3' key_field = 789 field1 = 'www' field2 = 'xxx' field3 = 1001 field4 = 5 ) )
*        MAPPED mapped
*        FAILED failed
*        REPORTED reported.
*
...
*      FIELDS key_field, field1, field2, field3, field4
*      ORDER BY key_field
*      INTO TABLE @DATA(tab_root6).
*
*    out->write( data = tab_root6 name = `tab_root` ).
*    out->write( |\n| ).
*
*    "Displaying response information
*    IF mapped IS NOT INITIAL.
...
*    ENDIF.
    ...
    read_dyn = VALUE #( ( %key-key_field = 1 %control = VALUE #( field1 = if_abap_behv=>mk-on field2 = if_abap_behv=>mk-on field3 = if_abap_behv=>mk-on field4 = if_abap_behv=>mk-on ) )
                        ( %key-key_field = 2 %control = VALUE #( field1 = if_abap_behv=>mk-on field2 = if_abap_behv=>mk-on field3 = if_abap_behv=>mk-on field4 = if_abap_behv=>mk-on ) ) ).

    rba_dyn  = VALUE #( ( %key-key_field = 1 %control = VALUE #( key_ch = if_abap_behv=>mk-on field_ch1 = if_abap_behv=>mk-on field_ch2 = if_abap_behv=>mk-on ) )
                        ( %key-key_field = 2 %control = VALUE #( key_ch = if_abap_behv=>mk-on field_ch1 = if_abap_behv=>mk-on field_ch2 = if_abap_behv=>mk-on ) ) ).

    op_tab   = VALUE #( ( op = if_abap_behv=>op-r-read entity_name = 'ZDEMO_ABAP_RAP_RO_M' instances = REF #( read_dyn ) results = REF #( read_dyn_result ) )
                        ( op = if_abap_behv=>op-r-read_ba entity_name = 'ZDEMO_ABAP_RAP_RO_M' sub_name = '_CHILD' full = abap_true instances = REF #( rba_dyn ) results = REF #( rba_dyn_result ) links = REF #( rba_dyn_link ) ) ).
