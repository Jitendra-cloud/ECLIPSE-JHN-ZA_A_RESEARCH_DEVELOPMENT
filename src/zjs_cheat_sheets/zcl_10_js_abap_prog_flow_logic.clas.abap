...
CLASS zcl_10_js_abap_prog_flow_logic DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_10_JS_ABAP_PROG_FLOW_LOGIC IMPLEMENTATION.
...
**********************************************************************
    ...
    DATA(idx) = cl_abap_random_int=>create( seed = cl_abap_random=>seed( )
                                            min = 1
...
**********************************************************************
    ...
    oref = NEW zcl_10_js_abap_prog_flow_logic( ).
    ...
    AND oref IS INSTANCE OF zcl_10_js_abap_prog_flow_logic
...
**********************************************************************
    ...
    oref_check = NEW zcl_10_js_abap_prog_flow_logic( ).

    CASE TYPE OF oref_check.
      WHEN TYPE zcl_10_js_abap_prog_flow_logic.
    ...
    IF oref_check IS INSTANCE OF if_oo_adt_classrun.
      out->write( `Type if_oo_adt_classrun? True!` ).
    ELSEIF oref_check IS INSTANCE OF zcl_10_js_abap_prog_flow_logic.
      out->write( `Type zcl_demo_abap_prog_flow_logic? True!` ).
